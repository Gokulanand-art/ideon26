...
/**
 * On-site registration route. When the channel is open (ONSITE_REGISTRATION_OPEN)
 * this page renders the full on-site registration wizard — same flow as
 * online, minus the payment step (the fee is collected at the venue).
 * When closed it only ever shows the closed notice.
 */
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-6xl px-4 pb-20 pt-12 sm:px-6 sm:pt-16 lg:px-8">
          <div className="text-center">
            <p className="kicker">
              <span className="kicker-dot">●</span> {config.eventName} · On-site registration
            </p>
            <h1 className="display mt-3 text-4xl text-fg sm:text-5xl">
              REGISTER FOR ON-SITE<span className="text-signal">.</span>
            </h1>
            <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-mut">
              Teams of 2–4 · ₹{config.feePerHead} per participant · pay at the
              venue · {onsiteLeft} on-site seats left.
            </p>
          </div>
